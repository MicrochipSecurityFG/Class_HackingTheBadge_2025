...
extern int aesEncryptECB(const uint8_t *input, size_t input_len, uint8_t *output, size_t output_size, uint8_t *expanded_key, size_t *cipher_len);
extern int aesDecryptECB(const uint8_t *input, size_t input_len, uint8_t *output, size_t output_size, uint8_t *expanded_key, size_t *plain_len);
